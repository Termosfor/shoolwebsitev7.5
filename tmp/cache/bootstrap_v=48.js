...
!function ($) {
 ...
 /* my */
  ...
  $(function () {
    $('#carousel1').on('slide', function ( e ) {
	$("#carousel1").find(".sel").removeClass("sel");
	var activeItem = $("#carousel1").find(".active").children().get(0).className;
	$("#carousel1").find("."+activeItem+"").next().addClass("sel");
	if (activeItem == "item3") $("#carousel1 .item1").addClass("sel");
    })
            $('.carousel1-controls .item1').click(function () {
                $('#carousel1').carousel(0);
		$("#carousel1").find(".sel").removeClass("sel");
                $("#carousel1 .item1").addClass("sel");
            });
            $('.carousel1-controls .item2').click(function () {
                $('#carousel1').carousel(1);
		$("#carousel1").find(".sel").removeClass("sel");
               $("#carousel1 .item2").addClass("sel");
            });
            $('.carousel1-controls .item3').click(function () {
                $('#carousel1').carousel(2);
		$("#carousel1").find(".sel").removeClass("sel");
               $("#carousel1 .item3").addClass("sel");
            });
            $('.carousel1-controls .item4').click(function () {
                $('#carousel1').carousel(3);
        	$("#carousel1").find(".sel").removeClass("sel");
               $("#carousel1 .item4").addClass("sel");
            });
            $('.carousel1-controls .item5').click(function () {
                $('#carousel1').carousel(4);
		$("#carousel1").find(".sel").removeClass("sel");
               $("#carousel1 .item5").addClass("sel");
            });
